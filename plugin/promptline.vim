...
command! -nargs=+ -bang -complete=customlist,<sid>command_completion PromptlineBashSnapshot call promptline#bash_snapshot(strlen("<bang>"), <f-args>)
